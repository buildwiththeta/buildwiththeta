---
title: A/B Testing Flutter apps with Theta: A comprehensive tutorial
---
...
## Step 1: Draw a Paywall visually within Theta

To create a paywall, you need to visually design the UI using Theta's design editor. 
Open your Theta dashboard, create a new project, and design a new component for the paywall.
