...
<img src="https://fftefqqvfkkewuokofds.supabase.co/storage/v1/object/public/theta-assets/logos/Theta_extended_negative.svg" width="400" alt="Theta cover"/>

# Build with Theta

Theta, an open-source hosted tool, revolutionizes the app development process by enabling dynamic UI changes without requiring app rebuilding or complex configurations. This tool will soon extend support for self-hosting and local development, further increasing its accessibility and versatility.
...
Theta is an effective tool for enhancing the efficiency of your app development process, especially when you need to rapidly design and integrate dynamic UI components. It is particularly beneficial for projects that require a mix of no-code and custom-coded solutions. 
