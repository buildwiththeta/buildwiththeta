...
<Accordion defaultOpen title="What is Theta."＞
...
<Accordion title="Is it good for mobile stores?"＞
...
<Accordion title="What platforms does Theta support?"＞
...
<Accordion title="Is it safe to use Theta inside my app?"＞
...
<Accordion title="Is it possible to use Theta to create an app?"＞
