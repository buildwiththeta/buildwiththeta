...
3. **Choose Theta Pro Plan:** Select the Theta Pro plan from the available options. You can choose a monthly or annual subscription based on your preference.

4. **Payment Details:** Enter your payment information to complete the upgrade process securely. We accept various payment methods for your convenience.
