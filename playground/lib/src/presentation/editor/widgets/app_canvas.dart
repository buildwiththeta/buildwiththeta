  ...
  Widget build(BuildContext context) {
    return BlocListener<ComponentFitCubit, ComponentFit>(
      ...
      child: BlocConsumer<DeviceModeCubit, DeviceModeState>(
        ...
        builder: (context, deviceState) => Center(
          child: BlocConsumer<StylesCubit, StylesState>(
                ...
                builder: (context, state) => state.maybeWhen(
                  loaded: (editorState) => Stack(
                    children: [
                      ColoredBox(
                        color: HexColor(
                            const FFill(paletteStyle: 'Background / Primary')
                                .getHexColor(context, treeState.colorStyles,
                                    treeState.theme)),
                        child: _PageWidget(
