...
class IconSizeControls extends StatefulWidget {
  ...
  @override
  State createState() => _IconSizeControlsState();
}

class _IconSizeControlsState extends State<IconSizeControls> {
  ...
  void load() {
    size = (widget.node.getAttributes[DBKeys.width] as FSize?) ?? FSize.ready();
