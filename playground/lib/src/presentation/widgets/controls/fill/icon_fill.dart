...
class IconFillControl extends StatefulWidget {
  const IconFillControl({
    super.key,
    required this.node,
  ...
  @override
  State<IconFillControl> createState() => _IconFillControlState();
}

class _IconFillControlState extends State<IconFillControl> {
  late FFill fill;
