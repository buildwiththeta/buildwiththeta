...
/// switcH
class SwitchOpenNode extends CNode {
  SwitchOpenNode({
    required final NodeID id,
    final NodeID? parentID,
    final CNode? child,
    ...
    final bool? isLocked,
          ...
          parentID: parentID,
          intrinsicState:
              const DynamicIntrinsicState().getStateByType(NType.switcH),
          defaultAttributes:
              const DefaultAttributesParse().getByType(NType.switcH),
          attributes: attributes ?? {},
          rectProperties: rectProperties ?? CNode.defaultRProperties,
          adapter: const WidgetAdapterParse().getByType(NType.switcH),
          description: description,
          childOrder: childOrder ?? 0,
          child: child,
          children: children,
  ...
  @override
  String toString() => 'SwitchOpenNode { id: $id, name: $name, type: $type }';

  String toStringExtended() =>
      'SwitchOpenNode { id: $id, name: $name, type: $type, parentID: $parentID, attributes: $getAttributes, childOrder: $childOrder, child: $child, children: $children }';
}
...
class DividerOpenNode extends CNode {
  ...
  @override
  String toString() => 'DividerOpenNode { id: $id, name: $name, type: $type }';
...
/// verticalDivider
class VerticalDividerOpenNode extends CNode {
  VerticalDividerOpenNode({
    required final NodeID id,
    final NodeID? parentID,
    final CNode? child,
    final List<CNode>? children,
    ...
    final bool? isLocked,
          ...
          name: name ?? 'Vertical Divider',
          parentID: parentID,
          intrinsicState: const DynamicIntrinsicState()
              .getStateByType(NType.verticalDivider),
          defaultAttributes:
              const DefaultAttributesParse().getByType(NType.verticalDivider),
          attributes: attributes ?? {},
          rectProperties: rectProperties ?? CNode.defaultRProperties,
          adapter: const WidgetAdapterParse().getByType(NType.verticalDivider),
          description: description,
          childOrder: childOrder ?? 0,
          child: child,
          children: children,
  ...
  static fromJson(String widgetType, Map<String, dynamic> json) {
    if (widgetType != NType.verticalDivider) {
      throw Exception('Invalid widget type');
    }
    ...
    return VerticalDividerOpenNode(
      id: json['id'],
      name: json['name'],
      description: json['description'],
      parentID: json['parent_id'],
  ...
  @override
  String toString() =>
      'VerticalDividerOpenNode { id: $id, name: $name, type: $type }';

  String toStringExtended() =>
      'VerticalDividerOpenNode { id: $id, name: $name, type: $type, parentID: $parentID, attributes: $getAttributes, childOrder: $childOrder, child: $child, children: $children }';
}
